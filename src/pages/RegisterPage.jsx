...
'auth/network-request-failed':'Error de red. Verifica tu conexión a internet.',
 ...
 <div>
 <label className="block text-xs font-normal mb-1 text-black">
 ...
 {registerError && (
 <div className="p-3 rounded-btn text-xs font-semibold text-center border bg-red-50 text-red-750 border-red-100">
 {registerError}
 </div>
 )}
 ...
 className="w-full flex items-center justify-center gap-2 mt-4 py-4 rounded-btn text-xs font-bold tracking-wider uppercase bg-primary hover:bg-primary-hover text-white transition-all active:scale-98 disabled:opacity-75"
 >
 {isRegistering ? (
 <>
