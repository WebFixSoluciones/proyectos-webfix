        ...
        {services.map(service => (
          <div key={service.id} className={`rounded-[10px] border flex flex-col justify-between overflow-hidden transition-all duration-300 hover:shadow-lg bg-white border-slate-200 hover:border-primary/30 shadow-sm`}>
            <div className="p-6 space-y-4">
              ...
              {/* Precio */}
              <div className="pt-2">
                <span className="text-[10px] text-gray-500 font-bold uppercase block tracking-wider">Inversión</span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-end gap-2 pt-2 border-t border-gray-500/5">
                  ...
                  <button 
                    type="submit" 
                    disabled={isSaving}
                    className="px-4 py-2 text-xs font-black uppercase tracking-wider rounded-[10px] bg-primary hover:bg-primary-hover text-white flex items-center gap-1.5 transition-colors disabled:opacity-60"
                  >
                    {isSaving ? (
                      <>
              ...
              <div className="space-y-4 py-2 text-center">
                ...
                <div className="flex flex-col gap-2 pt-4 border-t border-gray-500/5">
                  <button 
                    ...
                    className="w-full py-2.5 text-xs font-black uppercase tracking-wider rounded-[10px] bg-emerald-500 hover:bg-emerald-600 text-white flex items-center justify-center gap-1.5 shadow-md shadow-emerald-500/10 transition-colors"
                  >
