        ...
        <div className="p-8 rounded-[10px] border text-center max-w-xl mx-auto space-y-6 animate-in fade-in zoom-in-95 duration-300 bg-white border-slate-200 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            <button 
              ...
              className="flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-[10px] text-xs font-bold transition-all shadow-md"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-2">
              <button 
                type="submit" 
                disabled={isSaving}
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-primary hover:bg-primary-hover text-white rounded-[10px] text-xs font-bold transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSaving ? (
                  <>
